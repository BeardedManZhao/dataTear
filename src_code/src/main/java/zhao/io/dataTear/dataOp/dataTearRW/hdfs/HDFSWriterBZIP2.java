...
public class HDFSWriterBZIP2 extends Writer {
    ...
    public static HDFSWriterBZIP2Builder builder() {
        return new HDFSWriterBZIP2Builder();
    }
    ...
    public void flush() throws IOException {
        ...
        BZip2CompressorOutputStream bzip2OutputStream = new BZip2CompressorOutputStream(OKYA);
        bzip2OutputStream.write(byteArrayOutputStream.toByteArray());
