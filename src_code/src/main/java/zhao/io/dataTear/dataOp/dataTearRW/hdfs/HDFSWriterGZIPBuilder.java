 ...
 */
public class HDFSWriterGZIPBuilder implements Builder<HDFSWriterGZIP> {
     ...
     */
    @Priority("2")
    public HDFSWriterGZIPBuilder setIP_port(String IP, String port) {
     ...
     */
    @Priority("2")
    public HDFSWriterGZIPBuilder setKV(String key, String value) {
     ...
     */
    @Priority("3")
    public HDFSWriterGZIPBuilder setPathString(String pathString) {
     ...
     */
    @Priority("2")
    public HDFSWriterGZIPBuilder setPathObject(Path pathObject) {
     ...
     */
    @Priority("1")
    public HDFSWriterGZIPBuilder setFileSystem(FileSystem fileSystem) {
        this.fileSystem = fileSystem;
        return this;
    }

    @Override
    public HDFSWriterGZIP create() {
        try {
            if (pathObject == null) pathObject = new Path(pathString);
            return new HDFSWriterGZIP(fileSystem, pathObject);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
