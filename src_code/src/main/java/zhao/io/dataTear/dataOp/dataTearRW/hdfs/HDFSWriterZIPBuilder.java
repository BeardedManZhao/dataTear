...
public class HDFSWriterZIPBuilder implements Builder<HDFSWriterZIP> {
    ...
    /**
     * @param charset 需要使用的字符编码集类，可以通过"StandardCharsets.XXX" 枚举类获取
     *                <p>
     *                The character encoding set class to be used can be obtained through the "StandardCharsets.XXX" enumeration class
     * @return 链
     */
